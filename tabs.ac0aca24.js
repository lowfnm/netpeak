...
var nav = function nav() {
  ...
  var slideRect = nav.querySelector('.nav__slider-rect');
  var starterTab = document.getElementById('starter');
  var professionalTab = document.getElementById('professional');
  var companyTab = document.getElementById('company');
  nav.addEventListener('click', function (evt) {
    if (!evt.target.classList.contains('nav__link')) return;
    evt.preventDefault();
    navLinks.forEach(function (item) {
      return item.classList.remove('nav__link_active');
    });
    ...
    slideRect.style.transform = "translateX(".concat(evt.target.dataset.transform, "%)");
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/tabs.js"], null)
